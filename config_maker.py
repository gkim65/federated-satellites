...
epochs = [10,30,50,100] #[5,10,25,50,100]
sats = [10]#[1,2,5,10] #[1,2,5,10,25,50]
clusters = [2,3,4]# 2,5,10] #[1,5,25]
...
gs_list = ["[Sioux_Falls,Sanya,Johannesburg,Cordoba,Tromso,Kashi,Beijing,Neustrelitz,Parepare,Alice_Springs,Fairbanks,Prince_Albert,Shadnagar]"]
...
config_object["TEST_CONFIG"] = {
        ...
        "momentum": 0.9,
        "wait_time" : 7,
        "sim_fname" : "/datasets/landsat/10s_4c_s_landsat_star_inter.csv", #"/datasets/landsat/10s_10c_s_landsat_star.csv", 
...
folder_num = 3 #int(config_object["TEST_CONFIG"]["prox_term"])*6+18
        ...
        for epoch in epochs:
            for sat in sats:
                if test_num != 0:
                    ...
                    config_object["TEST_CONFIG"]["round"] = str(150*(cluster+1))
                    ...
                    config_object["TEST_CONFIG"]["name"] = name_list+str(cluster)
                    if config_object["TEST_CONFIG"]["n_cluster"] == "3":
                        config_object["TEST_CONFIG"]["sim_fname"] = "/datasets/landsat/10s_3c_s_landsat_star_inter.csv"
                    else:
                        config_object["TEST_CONFIG"]["sim_fname"] = "/datasets/landsat/10s_4c_s_landsat_star_inter.csv"
