...
but with config_fit different for satellites
...
class FedSat_Initial(Strategy):
    ...
    def __init__(
        ...
        *,
        ...
        self.satellite_access_csv = satellite_access_csv
    ...
    #     delta = timedelta(hours=2)
    #     client_list = []
    #     # print(self.satellite_access_csv.head(5))
    #     # i = 0
    #     while (timedelta(hours=3) > delta):
    #         client_list.append(int(self.satellite_access_csv['From Object'].iloc[self.counter][-2:-1]))
    #         # self.satellite_access_csv = self.satellite_access_csv.drop(index = self.counter)
    #         self.counter +=1
    #         delta = self.satellite_access_csv['Start Time Seconds datetime'].iloc[self.counter]-start_time
    #         # print(self.satellite_access_csv['Start Time Seconds datetime'].iloc[self.counter])
    #         # print(start_time)
    #         # print(delta)        
    #     print("satellite_client")
    #     print(client_list)
    #     # print(self.satellite_access_csv.head(5))
    ...
    #         client_manager.num_available()
    #     )
    #     print(min_num_clients)
    #     print(sample_size)
    #     clients = client_manager.all()#[x for x in client_manager.all() if x in client_list ]
    #     print([(x, fit_ins) for x in clients])
    #     print(self.counter)
